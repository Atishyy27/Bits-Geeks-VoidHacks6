   // IMS-master/server/routes/internship.js
   const express = require("express");
   const router = express.Router();
   const { internships } = require("../mockData"); // Import mock data

   // Example route to get internships
   router.get("/", (req, res) => {
       res.json(internships); // Return mock data instead of querying the database
   });

   // Add other routes as needed, using mock data
